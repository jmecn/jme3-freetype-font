...
public abstract class BaseTransform implements CanTransformVec3d {
    public static final BaseTransform IDENTITY_TRANSFORM = null;
    ...
    public abstract Vector2f transform(Vector2f src, Vector2f dst);
    @Override
    public abstract Vector3f transform(Vector3f src, Vector3f dst);
    ...
    static Vector2f makePoint(Vector2f src, Vector2f dst) {
        if (dst == null) {
            dst = new Vector2f();
        }
        return dst;
